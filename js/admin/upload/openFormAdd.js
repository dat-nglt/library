...
function openFormAdd() {
  ...
  addFormAdd.innerHTML = `
            ...
            <div class="list__form-title">
                <span><i class="fa-solid fa-book icon"></i> Tải lên tài liệu</span><i class="fa-solid fa-xmark close-icon"
            ...
            <div class="list__form-content"style="display: block">
                <div class="list__add-handmade"  style="display: flex; justify-content: center;">
                    ...
                    <label class="list__form-label">Tài liệu</label>
                ...
                <label class="list__form-label">Danh mục</label>
                    ...
                    <input type="text" class="list__form-input" id="input-name" required placeholder="Nhập tên sách">
                        ...
                        <div style="font-size: 18px; font-weight: 500; margin-top: 10px">File tài liệu số</div>
